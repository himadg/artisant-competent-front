# Textes intégrés — Page d'accueil (V5)

Récapitulatif des textes français intégrés sur la page d'accueil lors de l'intégration V5.
Source : `src/assets/i18n/fr.json` (namespaces `home.*` et `footer`). La version anglaise existe en miroir dans `en.json`.
...
- **Texte** : Payez vos travaux en 3 fois sans frais avec Klarna. Paiement sécurisé.

---

## 2. Hero

- **Titre (H1)** : Vos travaux, encadrés de A à Z. Finis les arnaques !
- **Sous-titre** : Artisan Compétent, c'est la première plateforme qui encadre réellement vos chantiers de rénovation et d'intervention d'urgence. Vous ne validez le paiement qu'une fois l'intervention terminée.
...
- **Titre (H2)** : Pourquoi tant de gens se font avoir sur leurs travaux
...
- **Titre (H2)** : 3 étapes pour des travaux sans mauvaise surprise

**Étape 1 — Décrivez votre besoin**
Remplissez le formulaire en 2 minutes : type de travaux, zone d'intervention, budget estimé. Plus vous êtes précis, meilleurs seront les retours des artisans.

**Étape 2 — Échangez avec des artisans vérifiés**
Chaque artisan sur la plateforme est vérifié : numéro SIRET valide, assurances obligatoires et certifications à jour, avis clients réels.
...
- **Titre (H2)** : CMOD : un conseiller à distance pour vos travaux
- **Paragraphe 1** : Vous n'êtes pas du métier et vous avez peur de vous faire avoir ? CMOD, c'est la possibilité de faire appel à un professionnel du bâtiment qui vous conseille à distance, par visioconférence, sur votre chantier.
- **Paragraphe 2** : En cas de doute ou de litige avec votre artisan, le rapport CMOD vient renforcer votre dossier avec un avis technique indépendant. Ce n'est pas une garantie juridique, c'est un levier concret pour faire valoir votre point de vue.

**Ce que ça change**
Sans mécanisme d'encadrement complet, on estime que plus d'un chantier sur deux finit bâclé, repoussé ou non terminé comme prévu. Chez Artisan Compétent, l'écrasante majorité des chantiers suivis sur la plateforme sont menés à leur terme dans les règles, et ce taux monte encore quand le client active un accompagnement CMOD dès le début du chantier.

**Conditions**

- Devis entre 2 000 € et 5 000 € : un appel de 20 minutes offert.
- Devis au-delà de 5 000 € : un appel de 45 minutes offert.
- Accompagnement complet du chantier : formules payantes disponibles, tarif sur demande.

---

## 8. Preuve sociale (avis)

> Section actuellement masquée tant qu'il n'y a pas au moins 3 avis réels (flag `reviewsEnabled`).

- **Titre (H2)** : Ils ont fait confiance à Artisan Compétent
- **Sous-titre** : Des avis réels, de vrais clients et de vrais artisans, après de vrais chantiers.
- **Note** : Chaque avis vient d'un client ou d'un artisan réel, après un chantier réellement encadré par la plateforme. Pas de faux profils, pas d'avis achetés.
- **Phrase forte** : La meilleure preuve que ça marche, c'est ceux qui l'ont testé.
- **Boutons** : Voir tous les avis Google · Voir tous les avis Trustpilot

---

## 9. Nos métiers

- **Titre (H2)** : Tous les métiers que vous cherchez, un seul réflexe
- **Introduction** : Que vous ayez besoin d'un plombier, d'un électricien, d'un serrurier ou d'un peintre, Artisan Compétent couvre la majorité des besoins métiers récurrents demandés par les Français. Chaque artisan est vérifié, chaque intervention est encadrée.
- **Texte sous la grille** : Vous ne trouvez pas exactement le métier dont vous avez besoin ? La plateforme évolue constamment et d'autres spécialités sont ajoutées au fur et à mesure que de nouveaux artisans rejoignent Artisan Compétent.
- **CTA** : Découvrir tous nos métiers

> La grille des 12 métiers réutilise les libellés existants du namespace `jobs.list.*`.
...
- Plombier urgence (fuite, dégât des eaux)
- Chauffagiste urgence (panne chaudière, plus de chauffage)
- Serrurier urgence (porte claquée, serrure cassée)
- Électricien urgence (coupure, court-circuit)
- Déboucheur urgence (canalisation bouchée, refoulement)

---

## 11. Nos villes d'intervention
...
## 12. Je suis un professionnel

- **Titre (H2)** : Vous êtes artisan ? Rejoignez la plateforme gratuitement.
- **Paragraphe 1** : Si vous avez vos assurances obligatoires (RC Pro, décennale, et les autres selon votre activité) ainsi que vos certifications à jour (RGE, Qualibat, etc. si vous proposez ce type de service), alors vous avez votre place ici.
- **Paragraphe 2** : L'inscription est gratuite. Vous ne payez rien tant que vous n'avez pas signé un devis avec un client. Et la commission d'Artisan Compétent porte uniquement sur la main d'œuvre. Rien sur les matériaux.
- **CTA** : S'inscrire gratuitement comme artisan
...
**Q5 — Est-ce que je peux payer en plusieurs fois ?**
Oui. Le paiement en 3 fois est disponible via Klarna directement sur la plateforme.

**Q6 — Artisan Compétent intervient partout en France ?**
La plateforme est en phase de déploiement progressif. Artisan Compétent couvre déjà les principales villes françaises et s'étend au fil des mois, avec pour objectif à terme de couvrir la France métropolitaine et les DOM-TOM jusqu'aux plus petits villages. Si votre commune n'est pas encore couverte, vous pouvez encourager vos artisans locaux à rejoindre la plateforme : plus ils sont nombreux, plus vite votre zone sera disponible. Un artisan sérieux n'a aucune raison de refuser un système encadré comme le nôtre.
...
## 14. Barre de confiance + CTA final

**Barre de confiance (4 éléments) :**

- Paiement encadré par Stripe
- Paiement en 3x via Klarna
- Suivi digital inaltérable
- Artisans vérifiés et certifiés

**CTA final :**

- Notre promesse ? Que vos travaux ne soient plus une source de stress.
- Assez de nuits blanches à se demander si l'artisan va revenir finir le chantier. Assez de devis qui explosent sans prévenir. Avec Artisan Compétent, chaque étape est encadrée, chaque euro est tracé, chaque validation est entre vos mains.
- **Boutons** : Je suis un professionnel · Je suis un particulier
...
> Footer intégré puis masqué (le footer V5 contient trop de liens non encore disponibles). Les textes ci-dessous existent dans `fr.json` mais ne sont pas affichés actuellement.

**Bloc newsletter WhatsApp :**

- Titre : Recevez nos conseils anti-arnaque et nos bons plans travaux directement sur WhatsApp.
- Sous-titre : Plus simple, plus direct, plus lu que par mail. Un message par mois maximum, zéro spam.
- Champ : Votre numéro de téléphone
- Checkbox : J'accepte de recevoir les messages WhatsApp d'Artisan Compétent.
- Bouton : Je m'abonne sur WhatsApp

**Navigation :** Accueil · Nos métiers · Nos villes · Comment ça marche · CMOD · Je suis un pro · Blog · Contact

**Adresse :** 66 avenue des Champs-Élysées, 75008 Paris

**Bas de footer :** Mentions légales · CGU · CGV · Politique de confidentialité
