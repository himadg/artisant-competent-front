...
import { CallOverlay } from './shared/components/call-overlay/call-overlay';
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, TranslocoModule, AnnouncementBanner, PrelaunchBanner, Header, Footer, Toast, CallOverlay],
