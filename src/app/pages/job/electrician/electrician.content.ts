...
export const electricianContent: JobPageContent = {
    ...
    body: [
      ...
      {
        kind: 'h2',
        text: 'Quand faire appel à un électricien vérifié',
      },
      {
        kind: 'p',
      ...
      {
        kind: 'h2',
        text: 'Pourquoi passer par Artisan Compétent pour vos travaux d’électricité',
      },
      {
        kind: 'p',
      ...
      {
        kind: 'h2',
        text: 'Combien coûte un dépannage ou une rénovation électrique',
      },
      {
        kind: 'p',
      ...
      },
      {
        ...
        rows: [
          ...
          [
            'Vérification assurances et habilitation NF C 18-510',
            'Rare',
            'Aucune',
            'RC pro, décennale, habilitation, IRVE si applicable',
          ],
          [
            'Paiement encadré',
            'Non',
          ...
          [
            'Conformité NF C 15-100 et Consuel',
            'Variable',
            'Aucune',
            'Imposée et tracée',
          ],
      ...
      {
        kind: 'h2',
        text: 'Les 3 pièges à éviter quand on cherche un électricien',
      },
      {
        kind: 'p',
      ...
      {
        kind: 'h3',
        text: 'Piège 1 : Le surdimensionnement de la mise aux normes',
      },
      {
        kind: 'p',
      ...
      {
        kind: 'h3',
        text: 'Piège 2 : L’installation non visée Consuel sur une rénovation lourde',
      },
      {
        kind: 'p',
      ...
      {
        kind: 'h3',
        text: 'Piège 3 : Le matériel substitué entre devis et pose',
      },
      {
        kind: 'p',
      ...
      {
        kind: 'h2',
        text: 'Électricien d’urgence 24h/24, 7j/7',
      },
      {
        kind: 'p',
      ...
      {
        kind: 'h2',
        text: 'Trouver un électricien vérifié dans votre ville',
      },
      {
        kind: 'p',
