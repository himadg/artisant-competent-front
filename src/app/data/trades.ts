...
export const TRADES: TradeInfo[] = [
  {
    ...
    metaDescription: (city) => `Électricien vérifié à ${city} : SIRET contrôlé, RC pro et décennale à jour, habilitation NF C 18-510, qualification IRVE pour bornes de recharge. Paiement encadré par séquestre Stripe — fonds libérés 48h après le chantier.`,
    h1: (city) => `Électricien vérifié à ${city} — du devis à la mise sous tension encadrée`,
    intro: (city) => `Les électriciens référencés sur Artisan Compétent à ${city} ont leur SIRET contrôlé, leurs assurances RC pro et décennale vérifiées, leur habilitation électrique NF C 18-510 pour les interventions sous tension et leur qualification IRVE pour la pose de bornes de recharge. Dépannage, tableau électrique, mise aux normes NF C 15-100, domotique, bornes IRVE : décrivez votre besoin et recevez un devis détaillé d'un professionnel vérifié de votre zone. Le paiement est encadré par séquestre Stripe — les fonds sont libérés 48h après la fin du chantier, sans réserve de votre part.`,
    keywords: (city) => `électricien vérifié ${city}, habilitation NF C 18-510 ${city}, borne recharge IRVE ${city}, domotique ${city}, mise aux normes NF C 15-100 ${city}`,
  },
  {
    slug: 'locksmith',
    i18nKey: 'locksmith',
  ...
  },
  {
    ...
    metaDescription: (city) => `Chauffagiste qualifié à ${city} pour l'installation, l'entretien ou la réparation de votre chaudière, VMC ou pompe à chaleur. Devis gratuit et paiement sécurisé.`,
  ...
  },
  {
    ...
    metaDescription: (city) => `Technicien climatisation et frigoriste à ${city}. Installation, entretien et réparation de climatisation. Devis gratuit, artisans certifiés, paiement sécurisé.`,
    h1: (city) => `Technicien climatisation & Frigoriste à ${city}`,
    intro: (city) => `Vous souhaitez installer ou faire réparer votre système de climatisation à ${city} ? Artisan Compétent vous connecte avec des techniciens frigoristes qualifiés RGE, maîtrisant les normes en vigueur. Mise en service, entretien préventif ou réparation d'urgence : recevez plusieurs devis et choisissez en toute transparence.`,
    keywords: (city) => `technicien climatisation ${city}, frigoriste ${city}, installation climatisation ${city}, réparation climatisation ${city}`,
  },
  {
    slug: 'glazier',
    i18nKey: 'glazier',
    ...
    metaDescription: (city) => `Vitrier et miroitier qualifié à ${city} pour vos vitrages, miroirs, fenêtres et verrières. Devis gratuit, paiement sécurisé sur Artisan Compétent.`,
    h1: (city) => `Vitrerie & Miroiterie à ${city}`,
    intro: (city) => `Pour tous vos travaux de vitrerie et miroiterie à ${city} — remplacement de vitrage, pose de miroirs, verrières, fenêtres — Artisan Compétent vous met en relation avec des artisans qualifiés. Finitions soignées et durabilité garanties. Comparez les devis et bénéficiez de notre paiement sécurisé.`,
